...
블로그를 만들면서 고민했던 것 중 하나가 **LCP 이미지**와 **그렇지 않은 이미지**를 분리해서 관리하는 것이었다. 
...
![[스크린샷 2026-01-22 오후 6.07.22.png]]
...
![[스크린샷 2026-01-22 오후 9.01.50.png]]
...
![[스크린샷 2026-01-24 오전 12.04.57.png]]
